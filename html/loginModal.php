                    ...
                    <div class="col-12">
                        <div class="card bg-dark text-white">
                            <div class="card-body p-4 text-center">
                                    ...
                                    <form action="class/classAcceso.php" method="POST">
                                        ...
                                        <div class="form-floating mb-4">
                                            ...
                                            <label class="form-label" for="captcha">
                                                <?php echo $_SESSION['ope_login']; ?>
                                            </label>
                                            </label>
                                        </div>

                                        <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="#" onclick="closeModal('loginModal'); loadModal('recuperarModal', 'modalContainerRecuperar', 'html/recuperarModal.html');">¿Olvidaste
                                                tu
                                                contraseña?</a></p>
                                ...
                                <div>
                                    <p class="mb-0">¿No tienes cuenta? <a href="#" onclick="closeModal('loginModal'); loadModal('registroModal', 'modalContainerRegistro', 'html/registroModal.html');" class="text-white-50 fw-bold">Regístrate</a>
                                    </p>
                                </div>
